    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" action="{{route('frontend-menu.submenu.update',$editData->id)}}" id="myForm">
                            {{csrf_field()}}
                                ...
                                <div class="col">
                                    ...
                                    <select name="menu_id" id="menu_id" class="form-control">
                                        <option value="">Select Menu</option>
                                            ...
                                            <option value="{{$menu->id}}" {{($editData->menu_frontend_id == $menu->id ? 'selected' : '')}}>{{$menu->menu_name}}</option>
                                            @endforeach
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" name="submenu_name" id="title_en" class="form-control" value="{{$editData->submenu_name}}">
                                </div>
                            </div><br/>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row linkpathDiv">
                                <div class="col">
                                    ...
                                    <input data-toggle="modal" data-target="#myModall" type="text" name="link" id="url_link" class="form-control url_link" value="{{$editData->link}}">
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table table-borderless text-center">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <th scope="row">{{$i++}}</th>
                                <td class="dd-handle">{{$menu->submenu_name}}</td>
                                {{-- <td>
