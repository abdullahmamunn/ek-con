                ...
                <div class="dd" id="nestable" style="width: 100%;">
                    <table class="table table-borderless text-center">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">{{$i++}}</th>
                            <td class="dd-handle {{($menu->status =='1')?('text-success'):'text-danger'}}">{{$menu->menu_name}}</td>
                            <td>
                                @foreach($menu->submenu as $submenu)
                                <span class="dd-handle {{($menu->status =='1')?('text-success'):'text-danger'}}">
                            ...
                            <td>
                                <ol class="dd-list new_data">
                                    <li class="dd-item" data-rand_id="{{$menu->id}}" data-title_en="{{$menu->menu_name}}" data-status="{{$menu->status}}" data-url_link="{{$menu->url}}">
                                
                                      <span class="menu-delete" data-target="{{$menu->id}}" style="font-size: 20px;z-index:10;position:absolute; right:5px; top:4px; cursor:pointer;"><i class="fa fa-trash text-danger"></i></span>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input type="text" name="menu_name" id="title_en" class="form-control form-control-sm" value="">
                        <input type="hidden" name="menu_id" id="menu_id" class="form-control form-control-sm" value="">
                      </div>
                    </div><br/>
                    <div class="row linkpathDiv">
                      <div class="col-md-12">
                        ...
                        <input data-toggle="modal" data-target="#myModall" type="text" name="url" id="url_link" class="form-control form-control-sm url_link" value="">
...
$.ajaxSetup({
  ...
  $(document).ready(function(){
    ...
    $(document).on("click",'.menu-delete',function(){
      var id = $(this).parents('.dd-item').attr('data-rand_id');
      // alert(id);
    ...
    $(document).on('click','.menu-edit',function(){
      ...
      var edit_rand_id = $('#menu_id').val(rand_id);
